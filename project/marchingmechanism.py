...
tone1 = Sound(duration=3, volume=60, pitch="C5")
tone2 = Sound(duration=3, volume=60, pitch="G5")
tone3 = Sound(duration=3, volume=60, pitch="A5")
tone4 = Sound(duration=3, volume=60, pitch="F5")
tone5 = Sound(duration=3, volume=60, pitch="E5")
tone6 = Sound(duration=3, volume=60, pitch="D5")
...
def drumming_mechanism():
    ...
    # Variable to know if drum was started
    DRUM_STARTED = False

    if DRUM_SENSOR.is_pressed() and not DRUM_STARTED:
        DRUM_MOTOR.set_power(100)
        DRUM_STARTED = True
    elif DRUM_SENSOR.is_pressed() and DRUM_STARTED:
